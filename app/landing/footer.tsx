    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              Automatiza la gestión de alquileres. Captura leads, valida inquilinos y cierra contratos más rápido.
            </p>
          ...
          <div className="footer-column">
            ...
            <p className="footer-description" style={{ marginBottom: "1rem" }}>
              Recibe tips de automatización y novedades del sector inmobiliario.
            </p>
        ...
        <div className="footer-bottom">
          <span>© 2025 RentAFlow. Todos los derechos reservados.</span>
